<template>
  <teleport to="body">
    ...
    <BaseFlatDialog
      :open="dialogArtistDelete.show"
      :title="dialogArtistDelete.title"
      :mode="dialogArtistDelete.mode"
      @close="closedialogArtistDelete"
    >
      <template #default>
        <p>{{ dialogArtistDelete.content }}</p>
      </template>
      <template #action>
        <button class="danger" @click="onDeleteArtist">Delete</button>
        <button class="" @click="closedialogArtistDelete">Close</button>
      </template>
    </BaseFlatDialog>
    <BaseFlatDialog
      :open="isLoading"
...
export default defineComponent({
  ...
  methods: {
    ...
    deleteArtistConfirm(artist_id: string) {
      this.dialogArtistDelete.artist_id = artist_id;
      this.dialogArtistDelete.show = true;
    },
    onDeleteArtist() {
      this.dialogArtistDelete.show = false;
      this.isLoading = true;
      this.deleteArtist({
        userToken: this.token,
        artistId: this.dialogArtistDelete.artist_id,
      })
        .then(() => {
